...
bubble的时间复杂度为：![[Pasted image 20260524192133.png]]当![[Pasted image 20260524192154.png]]时，bubble产生的空转时间占比对最终训练时长影响是微小的

# 数据并行 Data Parallelism
## 数据并行（DP）
![[Pasted image 20260524193244.png|418]]
...
（2）对梯度做一次**AllReduce**，**得到完整的梯度G**，产生单卡通讯量![[Pasted image 20260524205026.png]]。
...
- `h'`：参数W的hidden_size。
则每次forward的过程如下：
![[Pasted image 20260524213023.png|359]]
假设现在W太大，导致单卡装不下。我们需要把W切开放到不同的卡上，则我们面临三个主要问题：
- 怎么切分W。
- 切完W后，怎么做forward。
- 做完forward后，怎么做backward，进而求出梯度，更新权重。
### 按行切分权重
![[Pasted image 20260524222701.png]]
**forward**：W按照行维度切开后，X的维度和它不对齐了，这可怎么做矩阵乘法呢？很简单，再把X“按列切开”就行了，如下图所示：
![[Pasted image 20260524222604.png]]
**backward**：
![[Pasted image 20260524222819.png]]

### 按列切分权重
![[Pasted image 20260524222847.png]]
**forward**：W按照行维度切开后，X的维度和它不对齐了，这可怎么做矩阵乘法呢？很简单，再把X“按列切开”就行了，如下图所示：
![[Pasted image 20260524223053.png]]
**backward**：
![[Pasted image 20260524223510.png]]
...
![[Pasted image 20260529165434.png]]
fsdp比tp好在哪里？
...
![[Pasted image 20260529104853.png]]
...
# Ulysses SP 序列并行
## Ulysses的整体运作流程
![[Pasted image 20260529230941.png]]
...
- **每块gpu上的seq_chunk正常和![[Pasted image 20260529234816.png]]**相乘，得到`q/k/v_chunk = (N/p, d)`** 
...
![[Pasted image 20260529234616.png]]
...
### Ulysses bwd通讯量  
![[Pasted image 20260530143640.png]]
